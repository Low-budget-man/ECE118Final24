...
#define EVENT_CHECK_LIST  CheckTrack,  CheckTape, CheckBumper, CheckBattery,
...
#define TIMER11_RESP_FUNC PostMawHSM
...
#if NUM_SERVICES > 1
// the header file with the public fuction prototypes
#define SERV_1_HEADER "BattService.h"
// the name of the Init function
#define SERV_1_INIT InitBattService
// the name of the run function
#define SERV_1_RUN RunBattService
