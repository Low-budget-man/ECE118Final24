 ...
 *
 * OMW file to set up a Heirarchical SubState Machine to work with the Events and
...
#ifndef SUB_OMW_HSM_H  // <- This should be changed to your own guard on both
#define SUB_OMW_HSM_H  //    of these lines
