...
/**
 * @Function InitMawHSM(uint8_t Priority)
...
uint8_t InitMawHSM(uint8_t Priority)
{
    MyPriority = Priority;
...
/**
 * @Function PostMawHSM(ES_Event ThisEvent)
 ...
 *        Returns TRUE if successful, FALSE otherwise
 * @author J. Edward Carryer, 2011.10.23 19:25 */
uint8_t PostMawHSM(ES_Event ThisEvent)
{
    return ES_PostToService(MyPriority, ThisEvent);
}

/**
 * @Function RunMawHSM(ES_Event ThisEvent)
...
//			InitDepositSubHSM
    ...
    { // making a state transition, send EXIT and ENTRY
        ...
        RunMawHSM(ENTRY_EVENT); // <- rename to your own Run function
    }
